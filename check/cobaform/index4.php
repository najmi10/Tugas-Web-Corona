...
<body>
    <div class="box">
    <div class="middle">
        <h4 id="heading">Apakah anda melakukan kontak dengan orang yang sakit (batuk, flu, demam, sakit tenggorokan)?</h4><br>
        <a href="resiko.php"><button class="btn btn1">Iya</button></a>
        <a href="index5.php"><button class="btn btn2">Tidak</button></a>
    </div>
    </div>
