...
<body>
    <div class="box">
    <div class="middle">
        <h4 id="heading">Kemungkinan besar anda terinfeksi oleh Covid-19. Tetaplah dirumah selama 14 hari untuk memutuskan rantai penyebaran, hingga benar benar Virus itu hilang.</h4><br>
        <a href="http://localhost/corona_web/index-tampilan.php"><h4>Kembali ke Beranda</h4></a>
    </div>
    </div>
