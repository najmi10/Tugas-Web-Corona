...
<body>
    <div class="box">
    <div class="middle">
        <h4 id="heading">Apakah pernah muncul gejala sekitar 14 hari setelah mengunjungi kota yang berzona merah?</h4><br>
        <a href="resiko.php"><button class="btn btn1">Iya</button></a>
        <a href="index4.php"><button class="btn btn2">Tidak</button></a>
    </div>
    </div>
