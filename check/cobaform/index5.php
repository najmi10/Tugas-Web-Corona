...
<body>
    <div class="box">
    <div class="middle">
        <h4 id="heading"> Apakah Anda memiliki kontak dekat dengan seseorang yang bepergian ke luar Negeri dalam 14 hari terakhir yang menjadi sakit (batuk, demam, bersin, atau sakit tenggorokan)?</h4><br>
        <a href="resiko.php"><button class="btn btn1">Iya</button></a>
        <a href="resiko1.php"><button class="btn btn2">Tidak</button></a>
    </div>
    </div>
